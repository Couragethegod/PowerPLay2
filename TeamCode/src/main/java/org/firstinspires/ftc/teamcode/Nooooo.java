...
@Autonomous
public class Nooooo extends LinearOpMode {
    DcMotor Lwheels;
    DcMotor Rwheels;
    DcMotor Barm;
    DcMotor Uarm;
 ...
 /*       while (Lwheels.isBusy()) {
    ...
    /*    sleep(500);
        Rwheels.setTargetPosition(Rwheels.getCurrentPosition() + 830);
        ...
        Claw.setPower(-.6);
        sleep(250);
        Uarm.setTargetPosition(500);
        Barm.setTargetPosition(500);
        while (Uarm.isBusy() && Barm.isBusy()){
            sleep(15);
        }
        Lclaw.setPower(-1);
        ...
        Uarm.setTargetPosition(1440);
        Barm.setTargetPosition(1440);
        Lwheels.setTargetPosition(Lwheels.getCurrentPosition() + 780);
        while (Lwheels.isBusy() && Uarm.isBusy() && Barm.isBusy()) {
            sleep(15);
        }
    }
}